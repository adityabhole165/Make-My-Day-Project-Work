...
<head>
    ...
    <style>
        ...
        .btn-danger {
            background-color: #dc3545; /* Changed Delete button to red */
        }
        ...
        <div class="modal-dialog modal-confirm">
            <div class="modal-content">
                ...
                <div class="modal-footer justify-content-center">
                    ...
                    <a href="#" class="text-white" id="deleteLink">
    ...
    <script>
        ...
        document.querySelectorAll('.open-delete-modal').forEach(item => {
            item.addEventListener('click', function() {
                ...
                deleteLink.setAttribute('href', 'delete.php?c=' + menuId); // Update link with menu_id
            });
        });
    </script>
</body>
